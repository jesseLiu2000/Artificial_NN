...
----------第4----------
========== 50 ===== ===== train loss is  0.01635693572461605 ==========
========== 100 ===== ===== train loss is  0.04943089932203293 ==========
========== 150 ===== ===== train loss is  0.01769494079053402 ==========
========== 200 ===== ===== train loss is  0.09114958345890045 ==========
========== 250 ===== ===== train loss is  0.005889507941901684 ==========
========== 300 ===== ===== train loss is  0.03868115693330765 ==========
========== 350 ===== ===== train loss is  0.01636716164648533 ==========
========== 400 ===== ===== train loss is  0.07790554314851761 ==========
========== 450 ===== ===== train loss is  0.04889221116900444 ==========
========== 500 ===== ===== train loss is  0.004622828681021929 ==========
========== 550 ===== ===== train loss is  0.05191424861550331 ==========
========== 600 ===== ===== train loss is  0.03549697622656822 ==========
========== 650 ===== ===== train loss is  0.005864919628947973 ==========
========== 700 ===== ===== train loss is  0.0179473664611578 ==========
========== 750 ===== ===== train loss is  0.1554112732410431 ==========
========== 800 ===== ===== train loss is  0.024581676349043846 ==========
========== 850 ===== ===== train loss is  0.0441947802901268 ==========
========== 900 ===== ===== train loss is  0.07565521448850632 ==========
Train loss: 0.043876,Acc:0.986533
========== 50 ===== ===== test loss is  0.007988058030605316 ==========
========== 100 ===== ===== test loss is  0.0013820200692862272 ==========
========== 150 ===== ===== test loss is  0.07956147193908691 ==========
Test loss: 0.039798,Acc:0.987200
...
class Rnn(nn.Module):
    ...
    def __init__(self, in_dim, hidden_dim, n_layer, n_class):
        ...
        self.gru = nn.GRU(    # 这里可以换成nn.RNN(), 但不建议这么做，因为RNN很难训练
            input_size=in_dim,
